...
class WareHouseCloud extends React.PureComponent {
            ...
            <View>
                <ScrollView>
                    {store_items.map((key, i) => {
                        console.log(key)
                        return <WarehouseItem type="cloud" linkto={this.linkto} key={i} { ...key} />
                    })}
                </ScrollView>
            </View>
        )
...
export default connect(getProps('warehouse'))(WareHouseCloud)
