...
class MyTeamOther extends React.PureComponent {
    componentWillMount() {
    ...
    render() {
        ...
        const currentStack = this.props.team.stack.pageTwo;
        ...
        return (
            <View style={container}>
                <View style={styles.header}>
                    <Back backRouteName='myTeam' params={{ agent_id: agent_id ,first:true}} />
...
export default connect(getProps('team'))(MyTeamOther)
